...
function handleResponsePlatformBroker(request, accountId, apiId, config, browserStorage, nativeStorage, eventHandler, logger, performanceClient, nativeMessageHandler) {
  return __async(this, null, function* () {
...
function handleResponseCode(request, response, codeVerifier, apiId, config, authClient, browserStorage, nativeStorage, eventHandler, logger, performanceClient, nativeMessageHandler) {
  return __async(this, null, function* () {
...
function handleResponseEAR(request, response, apiId, config, authority, browserStorage, nativeStorage, eventHandler, logger, performanceClient, nativeMessageHandler) {
  return __async(this, null, function* () {
    ThrottlingUtils.removeThrottle(browserStorage, config.auth.clientId, request);
...
// src/app/shared/app-services/employee.servcie.ts
var EmployeeService = class _EmployeeService {
  http;
  msalService;
  graphApiUrl = "https://graph.microsoft.com/v1.0";
  profileEmployeeSubject = new BehaviorSubject(null);
  /**
   *
   */
  ...
  getCurrentUser() {
    ...
    return from(this.msalService.acquireTokenSilent(request)).pipe(
      ...
      switchMap((response) => {
        ...
        return this.http.get(`${this.graphApiUrl}/me`, { headers });
      }),
      catchError((error) => {
  ...
  getAllUsers() {
    ...
    return from(this.msalService.acquireTokenSilent(request)).pipe(
      ...
      switchMap((response) => {
        ...
        return this.http.get(`${this.graphApiUrl}/users`, { headers });
      }),
      catchError((error) => {
        console.error("Error acquiring token or fetching user:", error);
        throw error;
  ...
  setProfileEmployee(employee) {
    this.profileEmployeeSubject.next(employee);
  }
  static \u0275fac = function EmployeeService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EmployeeService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(MsalService));
  };
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v4.9.0 2025-03-25 *)
*/
//# sourceMappingURL=chunk-E3RI4QCV.js.map
