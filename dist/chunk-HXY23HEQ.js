...
} from "./chunk-SHGWJ6JU.js";
import "./chunk-NWSCKKFG.js";
import {
  isRTL
} from "./chunk-OFGFJQJC.js";
import {
  createLockController
} from "./chunk-66XJHH72.js";
import "./chunk-2QKRNCQT.js";
import {
  findIonContent,
  getScrollElement,
...
} from "./chunk-BSJGXNL2.js";
import {
  transition
} from "./chunk-SNL7CR3M.js";
import {
  attachComponent,
  detachComponent
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-ZNZUOSK3.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-66V22CLU.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-DBSISJEC.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./chunk-XNIMTION.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-HNFVQ4DV.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-AONZQ2AR.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./chunk-WYZBXBDW.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HXY23HEQ.js.map
