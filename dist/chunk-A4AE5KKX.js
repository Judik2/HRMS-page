...
// src/app/main/employee/birthday-calendar/birthday-calendar.component.ts
var _c02 = ["calendar"];
var _c18 = (a0, a1, a22, a3) => [a0, a1, a22, a3];
function BirthdayCalendarComponent_ng_template_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const arg_r2 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("alt", arg_r2.event.extendedProps.employeeName);
    \u0275\u0275property("src", \u0275\u0275pipeBind1(3, 2, arg_r2.event.extendedProps.avatar_src), \u0275\u0275sanitizeUrl);
  }
}
function BirthdayCalendarComponent_ng_template_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getSign(arg_r2.event.extendedProps), " ");
  }
}
function BirthdayCalendarComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5);
    \u0275\u0275listener("click", function BirthdayCalendarComponent_ng_template_3_Template_div_click_0_listener() {
      const arg_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onEmployeeClick(arg_r2.event.extendedProps.employeeId));
    });
    \u0275\u0275template(1, BirthdayCalendarComponent_ng_template_3_ng_container_1_Template, 4, 4, "ng-container", 6)(2, BirthdayCalendarComponent_ng_template_3_ng_template_2_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  ...
  if (rf & 2) {
    ...
    const signBlock_r4 = \u0275\u0275reference(3);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction4(4, _c18, arg_r2.event.extendedProps.badgeClass || "", arg_r2.event.extendedProps.textClass || "", arg_r2.event.extendedProps.type === "User Birthday" ? "employee-event" : "", arg_r2.event.extendedProps.type === "Child Birthday" ? "child-event" : ""));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", arg_r2.event.extendedProps.avatar_src)("ngIfElse", signBlock_r4);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(arg_r2.event.extendedProps.employeeName);
  }
}
var BirthdayCalendarComponent = class _BirthdayCalendarComponent {
  employeeRepository;
  idService;
  translate;
  router;
  ...
  calendarOptions = {
    ...
    events: [],
    datesSet: (dateInfo) => {
      this.loadBirthdaysForCurrentView(dateInfo.start, dateInfo.end);
    }
  };
  constructor(employeeRepository, idService, translate, router, eventService) {
  ...
  loadBirthdaysForCurrentView(startDate, endDate) {
    this.employeeRepository.getBirthdaysInRange(startDate, endDate).then((data) => {
      const events = data.map((item) => {
        let mappedEmployee = new EmployeeDto(item);
        return {
          start: this.formatToYear(new Date(item.birthday_date), startDate.getFullYear()),
          extendedProps: {
            type: item.is_child ? "Child Birthday" : "User Birthday",
            details: item,
            avatar_src: mappedEmployee.avatar_src,
            employeeId: item.id,
            employeeName: item.name,
            badgeClass: AppConstants.getRandomTransparentBadge().badge,
            textClass: AppConstants.getRandomTransparentBadge().text
          }
        };
      });
      this.calendarOptions.events = events;
      this.eventService.next(EventConstants.BIRTHDAY_CALENDAR_VIEW_LOADED, { startDate, endDate, count: events.length });
    }).catch((error) => {
      this.eventService.next(EventConstants.BIRTHDAY_CALENDAR_VIEW_LOAD_ERROR, { startDate, endDate, error });
    });
  }
  formatToYear(date, year) {
    return `${year}-${(date.getMonth() + 1).toString().padStart(2, "0")}-${date.getDate().toString().padStart(2, "0")}`;
  }
  onEmployeeClick(employeeId) {
    this.idService.setId("profile", employeeId);
    this.router.navigate(["/profile"]);
    this.eventService.next(EventConstants.BIRTHDAY_CALENDAR_EMPLOYEE_SELECTED, { employeeId });
  }
  getSign(details) {
  ...
  static \u0275fac = function BirthdayCalendarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BirthdayCalendarComponent)(\u0275\u0275directiveInject(EmployeeRepository), \u0275\u0275directiveInject(IdService), \u0275\u0275directiveInject(TranslateService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(EventService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BirthdayCalendarComponent, selectors: [["app-birthday-calendar"]], viewQuery: function BirthdayCalendarComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c02, 5);
    }
    if (rf & 2) {
  ...
  }, decls: 5, vars: 1, consts: [["eventContent", ""], ["signBlock", ""], [1, "card", "flex-fill"], [1, "card-body", "birthday-calendar"], [1, "w-100", 3, "options"], [1, "item-text", "cursor-pointer", "badge", 3, "click", "ngClass"], [4, "ngIf", "ngIfElse"], [1, "calendar-image"], ["appEnlargeImage", "", 3, "src", "alt"], [1, "sign-circle"]], template: function BirthdayCalendarComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 2)(1, "div", 3)(2, "full-calendar", 4);
      \u0275\u0275template(3, BirthdayCalendarComponent_ng_template_3_Template, 6, 9, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
  ...
  }, dependencies: [FullCalendarModule, FullCalendarComponent, CommonModule, NgClass, NgIf, AsyncPipe], styles: ['\n\n  .birthday-calendar table {\n  table-layout: fixed;\n}\n  .birthday-calendar .fc-event {\n  display: flex;\n  align-items: center;\n  padding: 0.2rem 0.7rem;\n  border-radius: 0.6rem;\n  min-height: 2.2rem;\n  max-width: 95%;\n  margin-bottom: 0.2rem;\n  font-size: 1rem;\n  font-weight: 500;\n  cursor: pointer;\n  border: none;\n  transition: background 0.2s;\n  width: fit-content;\n  background-color: transparent !important;\n  background: transparent !important;\n}\n  .birthday-calendar .fc-daygrid-day-frame {\n  overflow: visible;\n  height: auto !important;\n  max-height: none !important;\n  min-height: 0 !important;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n}\n  .birthday-calendar .fc-daygrid-day {\n  padding: 0 !important;\n  margin: 0 !important;\n}\n  .birthday-calendar .fc-event.employee-event, \n  .birthday-calendar .fc-event.child-event {\n  color: inherit;\n  background: inherit;\n}\n  .birthday-calendar .calendar-image, \n  .birthday-calendar .sign-circle {\n  width: 2rem;\n  height: 2rem;\n  border-radius: 50%;\n  overflow: hidden;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: #fff;\n  border: 2px solid white;\n  font-size: 1rem;\n  font-weight: 700;\n  color: #555;\n  flex-shrink: 0;\n}\n  .birthday-calendar .calendar-image img {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  display: block;\n}\n  .birthday-calendar .sign-circle {\n  background: var(--secondary-color);\n  color: #333;\n}\n  .birthday-calendar .item-text {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  width: auto;\n  min-width: 0;\n  border-radius: 1rem;\n  border: 2px solid rgba(var(--primary-color-rgb, 49, 43, 132), 0.3);\n  padding: 0.2rem 0.5rem 0.2rem 1.5rem;\n  position: relative;\n  font-family: "Roboto", sans-serif !important;\n}\n  .birthday-calendar .event-badge {\n  font-size: 0.8rem;\n  font-weight: 600;\n  padding: 0.1rem 0.5rem;\n  border-radius: 0.4rem;\n  background: #f5f5f5;\n  color: #888;\n  transition: all 0.2s;\n  position: absolute;\n  top: -0.7rem;\n  right: 0.5rem;\n  left: auto;\n  z-index: 2;\n  margin-left: 0;\n  box-shadow: 0 1px 4px rgba(0, 0, 0, 0.07);\n  border: 2px solid rgba(var(--primary-color-rgb, 49, 43, 132), 0.3);\n}\n@media (max-width: 600px) {\n    .birthday-calendar .fc-event {\n    font-size: 0.75rem;\n    padding: 0.05rem 0.15rem;\n    min-height: 1.2rem;\n    max-width: 100%;\n  }\n    .birthday-calendar .calendar-image, \n     .birthday-calendar .sign-circle {\n    width: 1rem;\n    height: 1rem;\n    font-size: 0.7rem;\n  }\n    .birthday-calendar .item-text {\n    gap: 0.2rem;\n    padding: 0.1rem 0.2rem 0.1rem 1.1rem;\n    min-width: 0;\n  }\n    .birthday-calendar .event-badge {\n    font-size: 0.65rem;\n    padding: 0.02rem 0.18rem;\n    top: -0.6rem;\n    right: 0.2rem;\n    left: auto;\n    border-radius: 0.3rem;\n    border: 2px solid rgba(var(--primary-color-rgb, 49, 43, 132), 0.3);\n  }\n    .birthday-calendar .item-text span:last-child {\n    max-width: 5.5rem;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  }\n}\n  .fc .fc-daygrid-body td, \n  .fc .fc-daygrid-day {\n  height: 100% !important;\n  min-height: 0 !important;\n  vertical-align: top !important;\n  padding: 0 !important;\n}\n  .fc-daygrid-day-frame {\n  height: 100% !important;\n  min-height: 0 !important;\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n}\n/*# sourceMappingURL=birthday-calendar.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BirthdayCalendarComponent, { className: "BirthdayCalendarComponent", filePath: "src/app/main/employee/birthday-calendar/birthday-calendar.component.ts", lineNumber: 27 });
})();

export {
  BirthdayCalendarComponent
};
//# sourceMappingURL=chunk-A4AE5KKX.js.map
