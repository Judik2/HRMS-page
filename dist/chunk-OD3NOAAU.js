...
var Segment = class {
  ...
  componentDidLoad() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./chunk-O3P5PFCM.js")).createGesture({
        el: this.el,
        gestureName: "segment",
        gesturePriority: 100,
        threshold: 0,
...
var SegmentButton = class {
  ...
  waitForSegmentContent(ionSegment, contentId) {
    return new Promise((resolve, reject) => {
      ...
      const check = () => {
        ...
        const segmentView = getNextSiblingOfType(ionSegment);
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      let segmentContent;
      try {
        segmentContent = yield this.waitForSegmentContent(segmentEl, this.contentId);
      } catch (error) {
  ...
  render() {
    ...
    return h(Host, {
      key: "e1e582b9a142cb07043ba08f02ad25f5a1fa5690",
      class: {
        [mode]: true,
        "in-toolbar": hostContext("ion-toolbar", this.el),
        "in-toolbar-color": hostContext("ion-toolbar[color]", this.el),
      ...
      key: "8621a028894fb382854ff28779d0cadd3d9035f7",
      ...
      key: "5c55858dbfb50734fb02d24091ebac3e0d05259f",
      class: "button-inner"
    }, h("slot", {
      key: "1f3bb8d76a1039ad648e202c650db06dfca88f79"
    })), mode === "md" && h("ion-ripple-effect", {
      key: "bda74b25bfdd431a8a36f0ee727b9184e9074321"
    })), h("div", {
      key: "ff11369e921d6d0a540c75c37f692a3853e903f7",
      part: "indicator",
      class: "segment-button-indicator segment-button-indicator-animated"
    }, h("div", {
      key: "74ec4ca69331ed3f155fd8a8a356545941887df1",
...
@ionic/core/dist/esm/ion-segment_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OD3NOAAU.js.map
